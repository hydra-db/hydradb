...
impl RuntimeConfig {
    ...
    fn from_values(values: BTreeMap<String, String>) -> ConfigResult<Self> {
        ...
        let config = Self {
            ...
            read_token_file: optional_path(&values, "GRAPH_READ_TOKEN_FILE"),
            write_token_file: optional_path(&values, "GRAPH_WRITE_TOKEN_FILE"),
            admin_token_file: optional_path(&values, "GRAPH_ADMIN_TOKEN_FILE"),
            tls_certificate,
            tls_private_key,
            allow_plaintext,
